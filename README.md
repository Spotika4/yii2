...
<ul>
	<li>в консоли инициализировать приложение через стандартный скрипт Yii2</li>
	<li>выполнить все миграции в интерфейсе common</li>
	<li>изменить необходимые настройки в файлах конфигурации в папке common/config/rbac</li>
